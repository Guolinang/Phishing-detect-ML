...
# Load dataset without FILENAME
df = pd.read_csv('dataset4.csv', sep=',', index_col=False)
if 'FILENAME' in df.columns:
    df = df.drop('FILENAME', axis=1)

# Assuming non-numeric columns need to be handled (e.g., Domain, TLD, Title are strings)
# Drop or encode them; here we drop strings for simplicity, adjust as needed
